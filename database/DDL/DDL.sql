...
CREATE TABLE IF NOT EXISTS `BIKES`.`SPECIAL_OFFER_PRODUCT` (
  ...
  INDEX `fk_SPECIAL_OFFER_PRODUCT_PRODUCT_ID1_idx` (`PRODUCT_ID` ASC),
  CONSTRAINT `fk_SPECIAL_OFFER_PRODUCT_PRODUCT_ID1`
...
CREATE TABLE IF NOT EXISTS `BIKES`.`SALES_ORDER_DETAIL` (
  ...
  `ROWGUID` CHAR(36) NOT NULL,
  `MODIFIED_DATE` DATETIME NOT NULL,
  PRIMARY KEY (`SALES_ORDER_DETAIL_ID`, `SALES_ORDER_ID`),
  UNIQUE INDEX `ID_table1_UNIQUE` (`SALES_ORDER_DETAIL_ID` ASC),
  ...
  CONSTRAINT `fk_SALES_ORDER_DETAIL_SPECIAL_OFFER_ID1`
    ...
    REFERENCES `BIKES`.`SPECIAL_OFFER_PRODUCT` (`SPECIAL_OFFER_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
